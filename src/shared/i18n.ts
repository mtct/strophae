...
const en = {
  ...
  generating_reply: 'Generating a reply…',
  ...
  stream_timeout: 'No response — the model timed out',
...
const it: Record<MessageKey, string> = {
  ...
  generating_reply: 'Sto generando una risposta…',
  ...
  stream_timeout: 'Nessuna risposta — il modello è andato in timeout',
